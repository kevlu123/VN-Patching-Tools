  ...
  local r1_1 = {
    ...
    _ButtonCreate = function(r0_3, r1_3, r2_3, r3_3, r4_3, r5_3, r6_3, r7_3, r8_3, r9_3, r10_3, r11_3, r12_3, r13_3, r14_3)
      ...
      function r15_3.bt_OnSePlay(r0_22)
        ...
        if r0_22.se_on ~= nil then
          ...
          r1_22:SndPlay("systemse", getSoundArcFileName("systemse", r0_22.se_on), r0_22.se_on, getSoundVolume("systemse"))
          r1_22:delete()
        end
      end
      function r15_3.bt_ClickSePlay(r0_23)
        ...
        if r0_23.se_click ~= nil then
          ...
          r1_23:SndPlay("systemse", getSoundArcFileName("systemse", r0_23.se_click), r0_23.se_click, getSoundVolume("systemse"))
          r1_23:delete()
        end
      end
    ...
    Movable = function(r0_48, r1_48)
      ...
      function r2_48.bt_SetMovableMove_XParam(r0_68, r1_68)
        ...
        local r2_68 = nil	-- notice: implicit variable refs by block#[6]
        if r3_68 > 0 then
