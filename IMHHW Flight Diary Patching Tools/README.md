...
- Download and unzip the two zip files and replace the game files.
  - <https://github.com/kevlu123/VN-Patching-Tools/releases/download/IMHHW-Flight-Diary-v1.2/IMHHW-Flight-Diary-v1.2-Part1.zip>
  - <https://github.com/kevlu123/VN-Patching-Tools/releases/download/IMHHW-Flight-Diary-v1.2/IMHHW-Flight-Diary-v1.2-Part2.zip>
