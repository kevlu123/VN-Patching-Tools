...
All fields little endian and all strings are null terminated in their respective encoding.
...
See the [Instruction Documentation](Ops.md).
...
| Type     | Field    | Description |
|----------|----------|-------------|
| int16    | ChoiceId | Unique choice ID. (Used for checking seen text?) |
