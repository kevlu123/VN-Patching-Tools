...
import lib.ws2_op_list as ws2_op_list
import lib.wsc_op_list as wsc_op_list
...
def gen_Opcode_cs():
    with open(this_dir / "../Compiler/Opcode.auto.cs", "w") as f:
        f.write(
...
def gen_OpFormat_cs():
    with open(this_dir / "../Compiler/OpFormat.auto.cs", "w") as f:
        f.write(
"""// This file is auto-generated by gen_ops.py
// Do not edit this file directly.
